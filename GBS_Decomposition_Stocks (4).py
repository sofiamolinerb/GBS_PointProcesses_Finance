...
def takagi(N, tol=1e-13, rounding=13): #Extracted from StrawberryFields source code
...
# Function to perform Takagi-Autonne decomposition and return necessary matrices (manually performed to see if it works for real matrices) we used this one for the rest of the exploration
...
# Plot the kernel matrix
fig, ax = plt.subplots(1, 1, figsize=(10, 8))
plot_heatmap(correlation_matrix, "Kernel Matrix - GBS", ax=ax, vmin=0, vmax=0.4, xticklabels=selected_stocks, yticklabels=selected_stocks)
...
# This last part is subject to exploration, basedon StrawberryFields points section
