...
filtered_df = all_stocks_df[all_stocks_df['Name'].isin(DPP_selected_stocks)]
...
# Define the compute_correlation_matrix_J function correctly to use with DataFrame
def compute_correlation_matrix_J(returns):
...
correlation_matrix = compute_correlation_matrix_J(log_returns)

# Plotting the correlation matrix as a heatmap
fig, axes = plt.subplots(1, 1, figsize=(10, 8))
sns.heatmap(correlation_matrix, annot=False, cmap="inferno", 
            xticklabels=DPP_selected_stocks, yticklabels=DPP_selected_stocks, 
