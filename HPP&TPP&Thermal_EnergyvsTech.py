...
plt.plot(range(len(sum_thresh_same_norm)), sum_thresh_same_norm, marker='o', linestyle='-', color='b', label='Threshold Detector (Energy Sectors)')
...
plt.plot(range(len(sum_thresh_diff_norm)), sum_thresh_diff_norm, marker='o', linestyle='-', color='g', label='Threshold Detector (Technology Sectors)')
